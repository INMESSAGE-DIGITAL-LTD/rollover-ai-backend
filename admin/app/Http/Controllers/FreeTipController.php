...
use App\Models\FreeTip as Tip;
use DataTables;
use Validator;
use App\Models\Notification;

class FreeTipController extends Controller
{
    /**
    ...
    */
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return DataTables::of($tips)
                ...
                ->addColumn('action', function($tip){
                    ...
                    $action .= '<a href="' . route('free_tips.edit', $tip->id) . '" class="dropdown-item">
                                        <i class="fas fa-edit"></i>
                                        ' . _lang('Edit') . '
                                    </a>';
                                    
                    $action .= '<a href="' . route('free_tips.show', $tip->id) . '" class="dropdown-item">
                                        <i class="fas fa-bell"></i>
                                        ' . _lang('Send Notification') . '
                                    </a>';
                    
                    $action .= '<form action="' . route('free_tips.destroy', $tip->id) . '" method="post" class="ajax-delete">'
                                . csrf_field() 
                                . method_field('DELETE') 
        ...
        return view('backend.free_tips.index');
    }
    ...
    */
    ...
    {
        if( ! $request->ajax()){
            return view('backend.free_tips.create');
        }else{
            return view('backend.free_tips.modal.create');
        }
    }
    ...
    */
    public function show(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            return redirect('free_tips')->with('success', _lang('Notification sent!'));
        } else {
            return response()->json(['result' => 'success', 'redirect' => url('/free_tips'), 'message' => _lang('Notification sent!')]);
        }
    }
    ...
    */
    public function edit(Request $request,$id)
    {
        $tip = Tip::find($id);
        if(! $request->ajax()){
            return view('backend.free_tips.edit', compact('tip'));
        }else{
            return view('backend.free_tips.modal.edit', compact('tip'));
        }  
    }
    ...
    */
    public function update(Request $request, $id)
    {
        ...
        if(! $request->ajax()){
            return redirect('free_tips')->with('success', _lang('Information has been updated sucessfully.'));
        }else{
            return response()->json(['result' => 'success', 'redirect' => url('free_tips'), 'message' => _lang('Information has been updated sucessfully.')]);
        }
    }
    ...
    */
    public function destroy(Request $request, $id)
    {
        ...
        if(! $request->ajax()){
            return redirect('free_tips')->with('success', _lang('Information has been deleted sucessfully.'));
        }else{
