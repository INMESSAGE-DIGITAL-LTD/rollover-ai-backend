...
class Tip extends Model
{
     ...
     */
    protected $fillable = [
        'title', 'league', 'datetime', 'odds_value', 'odds_number', 'result', 'team_one_name', 'team_one_image_type', 'team_one_url', 'team_one_image', 'team_two_name', 'team_two_image_type', 'team_two_url', 'team_two_image', 'status', 
    ];
