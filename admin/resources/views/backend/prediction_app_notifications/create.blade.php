...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form method="post" class="ajax-submit2iii" autocomplete="off" action="{{ route('prediction_app_notifications.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="image_type" data-selected="{{ old('image_type', 'none') }}" required>
