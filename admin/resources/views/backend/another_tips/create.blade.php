...
<form class="ajax-submit2" method="post" autocomplete="off" action="{{ route('another_tips.store') }}" enctype="multipart/form-data">
	@csrf
	<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="odds_value" class="form-control" value="{{ old('odds_value') }}" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
