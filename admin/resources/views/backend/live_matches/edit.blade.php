			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						@forelse($live_match->streamingSources as $source)
						<div class="field-group params-card mx-4 my-2 row" style="width: 100%;">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="source_title[]" class="form-control" value="{{ $source->title }}" required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">{{ _lang('Source Type') }}</label>
									<select class="form-control select2 source_type" name="source_type[]" data-selected="{{ $source->source_type }}" required>
							...
							<div class="col-md-12 streaming_url">
								<div class="form-group">
									...
									<input type="text" name="source_url[]" class="form-control" value="{{ $source->url }}" required>
								</div>
							</div>
							<div class="col-md-6 streaming {{ $source->source_type != 'streaming_url' ? 'd-none' : '' }}">
								<div class="form-group">
									...
									<select class="form-control select2" name="source_from[]" data-selected="{{ $source->source_from }}">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control select2" name="source_status[]" data-selected="{{ $source->status }}"  required>
										<option value="1">{{ _lang("Active") }}</option>
										<option value="0">{{ _lang("In-Active") }}</option>
									</select>
								</div>
						...
						<div class="field-group params-card mx-4 my-2 row" style="width: 100%;">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="form-control-label">{{ _lang('Status') }}</label>
									<select class="form-control select2" name="source_status[]" data-selected="1"  required>
										<option value="1">{{ _lang("Active") }}</option>
										<option value="0">{{ _lang("In-Active") }}</option>
									</select>
								</div>
